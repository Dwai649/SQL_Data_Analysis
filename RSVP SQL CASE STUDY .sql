...
--  3289 films fall under a single category.
...
SELECT 
  ...
  RANK() OVER (
    ORDER BY 
      COUNT(DISTINCT r.movie_id) DESC
...
limit 
 ...
 -- We have about 9 directors in total, Top 2 directors are Andrew Jones and A.L Vijay holds 5 movies and
 -- The rest 7 directors are Sion Sono, Chris Stokes,  Sam Liu, Steven Soderbergh, Jesse V, Johnson, Justin Price, Ozgur Baskar holds 4 movies
